## nohup sh train.sh > logs/train_VOC_15-5_use_KD_layer_weight.log 2>&1 &
## VOC 2012
...
python train_swin.py \
    --data_root ${DATA_ROOT} \
    --model deeplabv3_microsoft_swintransformer_swin_t \
    --gpu_id 1 \
    --crop_size 448\
    --lr ${LR} \
    --batch_size ${BATCH} \
...
##=============================================================
## nohup sh train.sh > logs/train_ADE_100-10.log 2>&1 &
## ADE20K
...
##=============================================================
## nohup sh train.sh > logs/train_ISPRS_4-1_KDoutlogits.log 2>&1 &
## ISPRS
# DATA_ROOT=/home/yb/dataset/ISPRS_2D/postdam/Incremental_RGB_600
# DATASET=ISPRS
# TASK=2-1 #[4-1, 2-3, 2-2-1, 2-1, offline]
# EPOCH=30
# BATCH=12
# LOSS=bce_loss
# KD_LOSS=KLDiv_loss
...
#     --batch_size ${BATCH} --train_epoch ${EPOCH} \
#     --loss_type ${LOSS} \
#     --KD_loss_type ${KD_LOSS} \
#     --use_KD_layer_weight\
#     --dataset ${DATASET} \
#     --task ${TASK} \
#     --overlap --lr_policy poly \
#     --pseudo \
#     --pseudo_thresh ${THRESH} \
#     --freeze  \
#     --bn_freeze \
#     --unknown \
#     --w_transfer \
#     --amp --mem_size ${MEMORY} --feature_decoupling \
#     --uncertainty_pseudo \
#     --data_ratio ${DATA_RATIO} 
