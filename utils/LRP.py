...
self,
    ...
    def attribute(self, inputs: TensorOrTupleOfTensorsGeneric, target: TargetType = None, additional_forward_args: Any = None,
        return_convergence_delta: bool = False,  verbose: bool = False,
    ...
    def compute_convergence_delta(self, attributions: Union[Tensor, Tuple[Tensor, ...]], output: Tensor) -> Tensor:
        """
    ...
    def _compute_output_and_change_weights( self, inputs: Tuple[Tensor, ...], target: TargetType, additional_forward_args: Any,) -> Tensor:
        try:
